...
test('new array should be added when new todolist is added', () => {
	...
	const action = todolistsThunk.addTodo.fulfilled({
		todo: {
			id: 'blabla',
			title: 'new todolist',
			order: 0,
...
test('propertry with todolistId should be deleted', () => {
	const action = todolistsThunk.removeTodo.fulfilled({id: 'todolistId2'}, '', {todolistId: 'todolistId2'});
...
test('tasks should be added for todolist', () => {
	const action = tasksThunks.fetchTasks.fulfilled({tasks: startState['todolistId1'], todolistId: 'todolistId1'}, 'requestId', 'todolistId');
